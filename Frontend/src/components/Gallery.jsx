  ...
  return (
    <div className='h-[300dvh] w-full flex flex-col relative'>
      ...
      <div className='z-10 bg-[#000000f1] justify-between w-full h-full flex flex-col p-2 md:p-14 gap-2 md:gap-8'>
        ...
        <div className='w-full h-[90%] flex flex-col gap-2 md:gap-10'>
          ...
          <div className='z-10 w-full h-[35%]'>
                <div className="grid grid-cols-2 md:grid-cols-3 h-full gap-2 grid-rows-3 w-full mx-auto">
          ...
          <div className='z-10 w-full h-[35%]'>
          <div className="grid grid-cols-2 md:grid-cols-3 gap-2 h-full grid-rows-3 w-full mx-auto">
      {images.map((src, index) => (
        <motion.div
        initial = {{opacity: 0, scale: 0.5}}
        whileInView={{opacity: 1, scale: 1}}
        ...
        <div className='w-full flex justify-center items-center h-[4%] md:h-[5%]'>
          <span className='w-[40%] md:w-[12%] flex text-lg justify-center items-center cursor-pointer h-[50%] rounded-md text-white bg-[#007AFF]'>View More</span>
        </div>
      </div>
    </div>
  )
