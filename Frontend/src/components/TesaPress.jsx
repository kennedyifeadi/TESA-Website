...
export const TesaPress = () => {
  ...
  return (
    <div className='w-full h-[120dvh] gap-4 px-8 flex flex-col items-center py-10'>
      <h1 className='text-black text-5xl w-full text-center' style={{ fontFamily: '"Aldrich", sans-serif' }}>TESA Press</h1>
