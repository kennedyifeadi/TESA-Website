...
export const About = () => {
  return (
    <div className='w-full h-[100dvh] bg-[#392B1A] px-8 flex py-10'>
      <div className='w-full h-full px-6 flex flex-col items-center gap-6'>
        <h1 className='w-full text-center text-5xl text-white' style={{ fontFamily: '"Aldrich", sans-serif' }}>About TESA</h1>
        <p className='w-full text-center text-white text-[20px] tracking-[2px]' style={{fontFamily:'"Poppins", sans-serif'}}>
