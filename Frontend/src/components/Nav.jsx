...
export const NavBar = () => {
  ...
  return (
    <div className='w-full h-[10dvh] flex px-4 absolute top-0 right-0 z-20'>
      ...
      <div className={`flex h-[80%] w-[50%] justify-center  ${searchClicked ? "md:w-[20%]": "md:w-[10%]"} items-center duration-500 transition-all ease-in-out absolute ${dialogClicked ? "right-[-500px]" : "right-0"}  top-[140%] md:top-0 md:relative`}>
        ...
        <div className={`h-full flex items-center w-[80%] ${searchClicked ? "md:w-[80%]": "md:w-[60%]"} duration-500 transition-all ease-in-out relative cursor-pointer`}>
          <input type="text" className={`${searchClicked ? "md:w-full md:h-[95%] md:border-2 md:p-2" : "md:w-0 md:h-0"} w-full p-2 h-full bg-white md:bg-transparent outline-none duration-500 rounded-md transition-all ease-in-out  md:border-[#007AFF]`} />
