        ...
        isAll ? (
          EventsObject.map((card, index) => (
            <div key={index} className='w-full h-[10%] md:h-[14%] flex mb-4'>
              ...
              <div className={`flex flex-col w-[80%] md:w-[90%] h-full relative before:absolute before:top-0 before:left-[-10px] before:h-full before:w-[2px] ${card.category === "News" ? "before:bg-[#FA8F21]" : card.category === "Activities" ? "before:bg-[#09FF00]" : "before:bg-[#007AFF]" }`}>
